...
def create_model():
    ...
    model = ZeroBooth(config=config.model, control_type="hed")
...
def generate_depth(cond_image_input):
    ...
    vis_control_image = preprocess_hed(cond_image_input, 512)
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            with gr.Row():
                ...
                hed_image = gr.Image(type="pil", interactive=True, label="hed image")
