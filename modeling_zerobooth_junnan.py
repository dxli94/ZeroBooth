...
class ZeroBooth(nn.Module):
    ...
    def forward(self, batch):
        ...
        # projected as SD input embeddings
        ...
        encoder_hidden_states = torch.cat([encoder_hidden_states,ctx_embeddings],dim=1)
    ...
    def generate(
        ...
        text_embeddings = torch.cat([text_embeddings,query_embeds],dim=1)    
