...
class ImageDirDataset(Dataset):
    ...
    @staticmethod
    def add_suffix(basename, suffix="_syn"):
    ...
    def __getitem__(self, index):
        ...
        tgt_image_path = os.path.join(self.image_dir, image_basename)
        inp_image_path = os.path.join(self.image_dir, self.add_suffix(image_basename))
        # tgt_image_path = inp_image_path
        # inp_image_path = tgt_image_path
        ...
        # transform
        if self.inp_image_transform is not None:
            inp_image = self.inp_image_transform(inp_image)
        else:
            # inp_image = image
            inp_image = inp_image
        ...
        if self.tgt_image_transform is not None:
            tgt_image = self.tgt_image_transform(tgt_image)
        else:
            tgt_image = tgt_image
